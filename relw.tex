...
Climer et al. proposed a graph-based approach to discover backbones which approximates lower and upper bounds to compute backbones \cite{CZ2002}. It is able to consistently find two to three more times backbone than previous work CDT~\cite{CDT1995}.% of instances of the travelling salesman problem .
